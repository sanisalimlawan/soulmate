...
export class LandingComponent {
  ...
  protected readonly trustPoints: readonly string[] = [
    ...
    'Guided from viewing to handover',
  ];
  ...
  protected readonly steps: readonly ProcessStep[] = [
    ...
    },
    {
      ...
      body: 'Tell us what caught your eye and pick a time that suits you. One tap sends your details straight to the right office on WhatsApp — no forms lost in an inbox.',
    },
    {
      index: '03',
